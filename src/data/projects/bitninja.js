...
export const projectBitninja = {
  ...
  ProjectInfo: {
    ...
    ObjectivesDetails: 'Create a new REST API for BitNinja, which can handle at least 15 million requests per day.',
    Technologies: 
      {
