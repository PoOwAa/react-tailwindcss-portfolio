		...
		<div className="block sm:flex gap-0 sm:gap-10 mt-14">
			<div className="w-full sm:w-1/3 text-left">
				...
				<div className="mb-7">
					...
					<div className="flex flex-wrap items-center gap-3 mt-5 text-primary-dark dark:text-ternary-light">
						<Tooltip id="tech-tooltip"/>
						{singleProjectData.ProjectInfo.Technologies.techs.map((tech) => 
							<div
								data-tooltip-content={tech.tooltip}
								data-tooltip-id="tech-tooltip"
								className="text-lg lg:text-2xl"
								key={`tech-icon-${tech.tooltip}`}
							>
								{tech.icon}
							</div>
      			)}
				...
				{/* Render only if SocialSharingHeading and SocialSharing has a value */}
				{singleProjectData.ProjectInfo.SocialSharingHeading && singleProjectData.ProjectInfo.SocialSharing && (
					<div>
						<p className="font-general-regular text-2xl font-semibold text-ternary-dark dark:text-ternary-light mb-2">
